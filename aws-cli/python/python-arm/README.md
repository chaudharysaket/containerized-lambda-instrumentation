...
aws lambda create-function \
  --function-name python-containerized-example-newrelic-arm \
  --architectures arm64 \
  --package-type Image \
  --code ImageUri=123456789012.dkr.ecr.us-east-1.amazonaws.com/python-example-newrelic:latest \
...
--function-name python-containerized-example-newrelic-arm \
--image-uri 123456789012.dkr.ecr.us-east-1.amazonaws.com/python-example-newrelic:latest \
--region us-east-1
``` 
